...
var INPUTLISTEN = function () {
  ...
  createClass(INPUTLISTEN, [{
    ...
    value: function _addDomEventHandlers(id) {
      var _this = this;
      ...
      this.bind(rcidom, {
        focus: function focus(v) {
          console.log("focus", v);
          _this.instance.time_event("input_blur");
          _this.instance["event"].track("input_focus", {
        ...
        blur: function blur(v) {
          ...
          _this.instance["event"].track("input_blur", {
            input_value: v.target.value
          });
        },
        keydown: function keydown(v) {
          console.log("keydown", v);
          _this.instance.time_event("input_keyup");
          _this.instance["event"].track("input_keydown", {
            input_value: v.target.value
          });
        },
        keyup: function keyup(v) {
          if (v.keyCode === 8) {
            _this.instance["event"].track("input_delete", {
              input_value: v.target.value
            });
          } else {
            _this.instance["event"].track("input_keyup", {
              input_value: v.target.value
            });
          }
        },
        change: function change(v) {
          ...
          _this.instance["event"].track("input_change", {
            input_value: v.target.value
          });
        },
        click: function click(v) {
          console.log("click", v);
          _this.instance["event"].track("input_click", {
            input_value: v.target.value
          });
        },
        select: function select(v) {
          console.log("select", v);
          _this.instance["event"].track("input_select", {
            input_value: v.target.value
          });
        },
        input: function input(v) {
          console.log("input", v);
          _this.instance["event"].track("input_input", {
            input_value: v.target.value
          });
        },
        paste: function paste(v) {
          console.log("paste", v);
          _this.instance["event"].track("input_input", {
            input_value: v.target.value
          });
